function Section4_DireccionamientoIpYRedesLan() {
    return (
      <div>
        ...
        <ul>
          <li>Utilizados por protocolos ARP y DHCP</li>
          <li>Los routers no propagan broadcasts</li>
          <li>Cada interfaz de router se conecta a un dominio de transmisión y las transmisiones solo se propagan dentro de ese dominio de transmisión específico</li>
        </ul>
        
        <h3 id="dir-ip-lan-segment-dom-broadcast">Problemas de Dominios de broadcast</h3>
        <ul>
          <li>Es que estos hosts pueden generar broadcasts excesivas y afectar la red de manera negativa</li>
          ...
          <li>Se puede utilizar para implementar directivas de seguridad entre subredes</li>
        </ul>
