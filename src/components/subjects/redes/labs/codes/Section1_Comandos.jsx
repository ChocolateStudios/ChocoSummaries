...
function Section1_Comandos() {
    ...
    return (
      <div>
        ...
        <h2 id="commands-gen">General</h2>

        <h3 id="commands-gen-ipconfig">ipconfig</h3>
        ...
        <h3 id="commands-gen-ipconfig-all">ipconfig /all</h3>
        ...
        {/* &lt; -> "<"   &gt; -> ">" */}
        <h3 id="commands-gen-ping">ping &lt;dirección&gt;</h3>
        ...
        <h3 id="commands-gen-ping-t">ping &lt;dirección&gt; -t</h3> 
        ...
        <h3 id="commands-gen-tracert">tracert &lt;dirección&gt;</h3>
        ...
        <h3 id="commands-gen-arp-a">arp -a</h3>
        ...
        <h3 id="commands-gen-netview">net view</h3>
        ...
        <h2 id="commands-disp-enl">Dispositivo de enlace</h2>

        <h3 id="commands-disp-enl-enable">enable (User -&gt; Admin mode)</h3>
        ...
        <h3 id="commands-disp-conf-t">configurate terminal | conf t</h3>
        ...
        <h3 id="commands-disp-enl-interface">interface &lt;interfaz&gt; | int &lt;interfaz&gt;</h3>
        ...
        <h3 id="commands-disp-enl-show-ip-int-br">show ip interface br | show ip int br</h3>
        ...
        <h3 id="commands-disp-enl-do">do &lt;comando&gt;</h3>
        ...
        <h3 id="commands-disp-enl-ip-address">ip address &lt;dirección ip&gt;  &lt;máscara&gt;</h3>
        ...
        <h3 id="commands-disp-enl-show-ver">show version</h3>
        ...
        <h3 id="commands-disp-enl-show-vlan-brief">show vlan brief</h3>
        ...
        <h3 id="commands-disp-enl-show-int-trunk">show interface trunk</h3>
        ...
        <h3 id="commands-disp-enl-vlan">vlan &lt;numero&gt;</h3>
        ...
        <h3 id="commands-disp-enl-swt-mode-access">switchport mode access</h3>
        ...
        <h3 id="commands-disp-enl-swt-access-vlan">switchport access vlan &lt;número de vlan&gt;</h3>
        ...
        <h3 id="commands-disp-enl-int-int">interface &lt;interfaz&gt;.&lt;vlan&gt; | int &lt;interfaz&gt;.&lt;vlan&gt;</h3>
        ...
        <h3 id="commands-disp-enl-encp-dot1q">encapsulation dot1Q &lt;vlan&gt;</h3>
