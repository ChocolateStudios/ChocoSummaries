function Section1_ConociendoConceptos() {
  return (
    <div>
        ...
        <ul>
            <li>
                <h3 id="con-dispositivos-intermedios">Sistemas intermedios</h3>
                <ul>
                    <li>
                        Router
                        <ul>
            ...
            <li>
                <h3 id="con-dispositivos-finales">Dispositivos finales</h3>
                <ul>
                    <li>Computadoras, servidores, laptops o hosts</li>
                </ul>
            </li>            
        </ul>
        ...
        <ul>
            <li>Un servicio es la información que pasa a través de las redes de comunicación</li>
            <li>Ejemplos: servicio web, dns, archivos de videoconferencia o teleconferencia</li>
        </ul>

        <p>Estos nos permiten las comunicaciones a través del <a href="#id2-2-2">Internetwork</a></p>
        
        <h2 id="con-medios-transmision">También existen los medios de transmición</h2>
        <ul>
            <li>
                <h3 id="con-medios-transmision-cables">Basados en cables</h3>
                <ul>
                    <li>
                        Cable Coaxial
                        <ul>
                            <li>Ej: cable para conectar televisión a antena, cable que conecta al model de casa (antes de fibra óptica)</li>
                        </ul>
                    </li>
            ...
            <li>
                <h3 id="con-medios-transmision-inalambricos">Inalámbricos</h3>
                <ul>
                    <li>
                        Espectro radioeléctrico
                        <ul>
                            <li>Conjunto de bandas de frecuencia donde se transmiten las señales inalámbricas</li>
                            <li>Señales inalámbricas, de frecuencia o microondas</li>
                        </ul>
                    </li>
                    <li>
                        Infrarojos
